package com.printforge.admin.settingsservice.controller;

import com.printforge.admin.settingsservice.dto.UpdateContactInfoRequest;
import com.printforge.admin.settingsservice.dto.UpdateFeatureToggleRequest;
 ...
 * notifications/receipts, and the admin dashboard UI reads the feature
 * toggles' current state too, not just admins/staff. They rely on
 * SecurityConfig's default `anyRequest().authenticated()`. Only the PATCH
 * (mutation) endpoints are locked to ADMIN.
 *
