package com.printforge.payment.notificationservice.model;
 ...
 * createNotification() call sites (PaymentService) need it too and there's
 * no REST call between services for this.
 */
