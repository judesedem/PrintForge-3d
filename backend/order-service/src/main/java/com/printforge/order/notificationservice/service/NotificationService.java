package com.printforge.order.notificationservice.service;

import com.printforge.order.notificationservice.exception.NotificationNotFoundException;
import com.printforge.order.notificationservice.model.Notification;
import com.printforge.order.notificationservice.repository.NotificationRepository;
import com.printforge.order.settingsservice.model.FeatureToggle;
import com.printforge.order.settingsservice.model.FeatureToggleKeys;
import com.printforge.order.settingsservice.repository.FeatureToggleRepository;
...
public class NotificationService {
    ...
    public Notification createNotification(Long userId, String title, String message, String type, String deepLink) {
        ...
        // createNotification() call site in this service (PrintQueueService,
        // PrintJobFacadeController) funnels through here, so gating just
        // this one method turns notifications off for this service without
