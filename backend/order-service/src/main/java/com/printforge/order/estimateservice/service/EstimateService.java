package com.printforge.order.estimateservice.service;

import com.printforge.order.entity.Role;
...
public class EstimateService {
    ...
    public Estimate calculateAndSaveEstimate(Long fileId, String quality, Integer infillPercent,
        ...
        // .Material) — the same table this service's own MaterialsController
        // AND marketplace-service's separate EstimateService copy read/write.
        // A previous version of this method had its own hardcoded if/else
        // ladder here, independent of both of those — all three had already
        // drifted (PETG/CARBON_FIBER disagreed on price). Reading one table
        // instead of three hardcoded copies is what closes that gap.
