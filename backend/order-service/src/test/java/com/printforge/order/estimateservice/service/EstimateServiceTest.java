 ...
 * EstimateServiceTest — proves the size used in the cost calculation
 * comes from the actual stored file, not a number the client made up, and
 * that bad quality/materialType/fileId are rejected instead of silently
 ...
 *
 * Run with: ./mvnw -pl order-service test -Dtest=EstimateServiceTest
 */
